...
If we look at the data we see that there are NAs in certain places of the dataset. So let's remove those by omitting them.
...
We can see that there are some outliers from 2009-2013, in addition, the 2022 data is not complete. Therefore, Let's filter them out and obtain a complete set of data, the one we will be using for our report below.
