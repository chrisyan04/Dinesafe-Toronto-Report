...
Steps:
- first create a table that a column that represents the number of thefts in that neighborhood.
- then with the columns we do case whens to filter the neighborhoods
- then do the scatterplot
```{r}
