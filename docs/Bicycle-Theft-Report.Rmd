...
newly added by armaan:

The graph below shows the amount of bikes stolen in the first half of years 2019 and 2020.

```{r}

data = origin %>% filter(Occurrence_Year %in% c(2019,2020) & Report_DayOfYear<=182)

ggplot(data, aes( x=Report_DayOfYear)) +
